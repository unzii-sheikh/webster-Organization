...
namespace Website.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private WebsiteUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(WebsiteUser)}'. " +
                    $"Ensure that '{nameof(WebsiteUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
